...
export default class ListBookingDo extends React.Component{
    ...
    .then(res => {
      ...
      if (statusCode === 200) {
        ...
        for (let index = 0; index < data.length; index++) {
          if(data[index].booking_service_status=="do")
...
pathname:"/admin/ver-booking-finalizado",
...
<h5 className="text-white mb-0 font-weight-bold display-4">Bookings Finalizados</h5>
</div>
</Container>
</div>

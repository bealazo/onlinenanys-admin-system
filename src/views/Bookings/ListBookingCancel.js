...
export default class ListBookingCancel extends React.Component{
    ...
    .then(res => {
      ...
      if (statusCode === 200) {
        ...
        for (let index = 0; index < data.length; index++) {
          if(data[index].booking_service_status=="cancel")
...
pathname:"/admin/ver-booking-cancelado",
...
<h5 className="text-white mb-0 font-weight-bold display-4">Bookings Cancelados</h5>
</div>
</Container>
</div>

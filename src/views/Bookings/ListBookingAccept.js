...
export default class ListBookingAccept extends React.Component{
    ...
    .then(res => {
      ...
      if (statusCode === 200) {
        ...
        for (let index = 0; index < data.length; index++) {
          if(data[index].booking_service_status=="accept")
...
pathname:"/admin/ver-booking-aceptado",
...
<h5 className="text-white mb-0 font-weight-bold display-4">Bookings Aceptados</h5>
</div>
</Container>
</div>

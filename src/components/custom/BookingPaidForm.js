...
const BookingPaidForm = ({ form,onChangeStatus,onChangeReviews,onSubmit,onCancel}) => (
...
BookingPaidForm.defaultProps = {
  title: "Editar pieza"
};

export default BookingPaidForm;

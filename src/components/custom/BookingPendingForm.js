...
const BookingPendingForm = ({ form,onChangeStatus,onChangeReviews,onSubmit,onCancel}) => (
...
BookingPendingForm.defaultProps = {
  title: "Editar pieza"
};

export default BookingPendingForm;

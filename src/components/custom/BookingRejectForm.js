...
const BookingRejectForm = ({ form,onChangeStatus,onChangeReviews,onSubmit,onCancel}) => (
...
BookingRejectForm.defaultProps = {
  title: "Editar pieza"
};

export default BookingRejectForm;

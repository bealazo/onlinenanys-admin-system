...
NannyUpdateApprovedForm.propTypes = {
  /**
...
NannyUpdateApprovedForm.defaultProps = {
  title: "Actualizar nanny"
};

export default NannyUpdateApprovedForm;

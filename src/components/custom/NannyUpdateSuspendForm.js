...
NannyUpdateSuspendForm.propTypes = {
  /**
...
NannyUpdateSuspendForm.defaultProps = {
  title: "Actualizar nanny"
};

export default NannyUpdateSuspendForm;
